...
class ActiveTimers extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ActiveTimers(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> runningSince = GeneratedColumn<int>(
    'running_since',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  @override
  ActiveTimers createAlias(String alias) {
    return ActiveTimers(attachedDatabase, alias);
  }
...
class DatabaseAtV18 extends GeneratedDatabase {
  ...
  late final ActiveTimers activeTimers = ActiveTimers(this);
